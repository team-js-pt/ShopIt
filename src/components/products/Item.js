                            ...
                            return (
                                <div className="col-xl-3 col-md-4 col-sm-6 my-4" key={ind}>
                                    ...
                                    <div className="card mx-3  d-flex align-items-center" style={{ borderColor: "rgba(0,0,0,0.14)", boxShadow: "0 2px 8px 0 rgba(0, 0, 0, 0.1)", borderRadius: "3px", height: "295px", width: "240px" }}>
                                        <Link to={`/${val.category}/${val.id}`} style={{ textDecoration: 'none', color: 'black' }}><div style={{ height: "160px", width: '200px' }}> <img className="card-img-top pt-3" src={val.url} onClick={() => { this.props.singleItemAdd(val) }} alt="Card image cap" style={{ height: '100%', width: '100%' }} /></div></Link>
                                        <div className="card-body" style={{ height: "135px" }}>
                                            ...
                                            <div className="card-text d-flex justify-content-around align-items-center">
                                                ...
                                                <button onClick={() => { this.props.addToCart(val, this.props.profile.userid) }} className="border rounded-circle" style={{ outline: 'none', backgroundColor: "#008081", color: 'white', fontSize: '22px', fontWeight: 'bolder' }} data-toggle="modal" data-target="#myModal">+</button>
