...
class AddToCart extends Component {
    ...
    render() {
        ...
        (this.props.mobiles&&this.props.mobiles.length>1)?array.push(this.props.mobiles[0]):'';
        (this.props.beauty&&this.props.beauty.length>1)?array.push(this.props.beauty[0]):'';
        (this.props.sports&&this.props.sports.length>1)?array.push(this.props.sports[0]):'';
        (this.props.appliances&&this.props.appliances.length>1)?array.push(this.props.appliances[0]):'';
